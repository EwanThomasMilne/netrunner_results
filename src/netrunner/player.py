...
class Player:
    ...
    def add_tournament_results(self, tournament_id: str, t_player: TournamentPlayer, date: str = None, region: str = None, online: str = None, tournament_name: str = None, tournament_url: str = None, tournament_level: str = None, meta: str = None, force: bool = False):
